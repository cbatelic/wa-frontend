<template>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-56">
				<div class="relative ">
				...
				<h5 class="text-gray-300 font-semibold -mr-10 -mt-3">This area is forbidden!</h5>
				<p class="text-gray-100 mt-2 mb-6">We are sorry but the page you are looking for is not allowed.</p>
                <router-link to="/naslovna">
				<a
					class="bg-blue-400  px-5 py-3 text-md shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
					Go Home
				</a>
                </router-link>
			</div>
