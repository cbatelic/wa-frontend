 <template>
  <div class="antialiased bg-gray-100 dark-mode:bg-gray-900 border-b-2 border-gray-900 shadow-lg shadow-gray-400" >
  <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    <div class="flex mx-auto md:items-center md:justify-between md:flex-row">
      ...
      <input type="search" name="q" class="md:w-96 lg:w-96 py-2 text-sm text-black bg-white rounded-md pl-10 focus:outline-none focus:bg-gray-800 focus:text-black" placeholder="Search..." autocomplete="off">
        ...
        <button class="rounded-lg justify-end lg:hidden focus:outline-none focus:shadow-outline">
      ...
      <nav class="flex-col flex-grow hidden md:pb-0 lg:flex justify-end md:flex-row bg-blue-400 " >
       <router-link to="/naslovna" class="bg-blue-600 mr-2 rounded-md py-2"> <a class=" pr-3 py-3 mt-2 text-white text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" >Home</a></router-link>
       <router-link to="/terrain" class="bg-blue-600 mr-2 rounded-md py-2" > <a class="pr-3 py-3 mt-2 text-white text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">Terrain</a></router-link>
       <router-link to="/account" class="bg-blue-600 mr-2 rounded-md py-2"> <a class="pr-3 py-3 mt-2 text-white text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">Account</a></router-link>
     ...
     <button type="button" @click="logout()" class="bg-white ml-5 rounded-md"> <a  class=" px-2 mt-1 text-blue-600 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0  hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">Logout</a></button>
      </nav>
      </div>
    </div>
  </div>
